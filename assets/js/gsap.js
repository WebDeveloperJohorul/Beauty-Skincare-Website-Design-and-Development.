...
(function($) {
    ...
    var gsapFunction = function() {
        ...
        var initParallax = function() {
            if (!checkSelectorExistence('.parallax')) {
                return;
            }
        ...
        var initBannerParallax = function() {
            if (!checkSelectorExistence('.banner-parallax')) {
                return;
            }
        ...
        var initGsapMarquee = function() {
            if (!checkSelectorExistence('.gsap-marquee')) {
                return;
            }
        ...
        var initGsapScrollMarquee = function() {
            if (!checkSelectorExistence('.gsap-scroll-marquee')) {
                return;
            }
        ...
        var initDataTP = function() {
            if (!checkSelectorExistence('[data-bottom-top]')) {
                return;
            }
        ...
        var initBlogScroll = function() {
            if (!checkSelectorExistence('.gspa-blog-scroll')) {
                return;
            }
        ...
        var initBlogScroll2 = function() {
            if (!checkSelectorExistence('.luxury-spa-blog-scroll')) {
                return;
            }
        ...
        var initPortfolioScroll = function() {
            if (!checkSelectorExistence('.gspa-portfolio-scroll')) {
                return;
            }
        ...
        var initGSAPGallery = function() {
            if (!checkSelectorExistence('.gsap-gallery-area')) {
                return;
            }
